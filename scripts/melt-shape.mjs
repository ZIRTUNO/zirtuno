/**
 * THE SHAPE GATE — the measurement melt-mass.mjs is blind to.
 *
 ...
 *
 * Run:
 *   node scripts/melt-shape.mjs                 the gate, at the shipped n
 *   node scripts/melt-shape.mjs --sweep 1,2,3,6 compare combination exponents
 *   node scripts/melt-shape.mjs --melts 0,3     a subset, for a quick loop
 *
...
// same rule melt-mass.mjs states — not an aspiration. Measured on the eight
