...
// swells (tools/melt-shape.mjs measured 171% for the bridge this replaces).
...
// Measured as a ratio against the melt's OWN endpoints, the way tools/melt-mass.mjs
...
// 24% is the budget tools/melt-mass.mjs already gates every pillar melt against.
check(
  bump < 1.24,
