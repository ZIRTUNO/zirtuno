 ...
 * paraphrase of it (scripts/_melt-sim.mjs explains the port and its limits).
 *
 *   node scripts/melt-mass.mjs            # report every melt
 *   node scripts/melt-mass.mjs --gate     # exit 1 on regression
 *   node scripts/melt-mass.mjs --pairs 1,4 --steps 41
 */
