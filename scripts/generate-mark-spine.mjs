 ...
 *
 *   node scripts/generate-mark-spine.mjs
 *
 ...
 *
 * Method, reusing what `generate-intro-trace.mjs` established as this repo's one
...
const arr = (a) => `[${a.join(",")}]`;
const src = `/**
 * THE MARK'S SPINE — GENERATED by scripts/generate-mark-spine.mjs.
