 ...
 *   TAG=after  node scripts/tools/melt-compare.mjs
 *   TAG=before node scripts/tools/melt-compare.mjs      # after swapping the kernel
 *   MODE=compose node scripts/tools/melt-compare.mjs
 */
