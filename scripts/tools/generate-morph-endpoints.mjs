...
//
//   node scripts/tools/generate-morph-endpoints.mjs            (K/COVER/MAXR/MINPX to tune)
//
...
const fileBody = `/**
 * Metaball MORPH-ENDPOINT clouds — GENERATED by scripts/tools/generate-morph-endpoints.mjs.
