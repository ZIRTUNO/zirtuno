...
export const COAL = {
   ...
   *
   * Liquid RUNS when it is let go and is drawn back slowly — `THREAD` in
   * membrane.mjs splits its own springs for exactly this reason. The lift did
   * not, and on one constant the return was a decelerating rush: 44 px of lift
