/**
 * FROZEN legacy symbol data — consumed ONLY by the retiring raymarch/mesh hero
 * paths (lib/webgl/symbols.ts → MetaballScene / mesh-states). This is the exact
 * snapshot those paths were last visually verified against; freezing it decouples
 * them from `symbols.data.mjs`, which now evolves freely as the NEW field hero's
 * morph endpoints (metaball-morph-spec v1.2). Do not edit — it retires with
