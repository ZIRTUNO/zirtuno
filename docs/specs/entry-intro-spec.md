# docs/specs/entry-intro-spec.md — S1.10, "Two Ideas, One Form"
...
> `scripts/tools/generate-intro-trace.mjs` (the generator),
...
`node scripts/tools/generate-intro-trace.mjs` (`npm run intro:trace`) derives
