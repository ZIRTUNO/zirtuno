# docs/references.md — Zirtuno Website v0.3
...
1. Read `AGENTS.md` and the relevant part of `docs/specs/build-spec.md`.
...
`docs/specs/metaball-morph-spec.md §§2–5` and the shader source. External demos cannot
override them.
